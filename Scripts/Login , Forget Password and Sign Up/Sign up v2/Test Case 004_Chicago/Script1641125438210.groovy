...
WebUI.click(findTestObject('Sign Up v2/Chicago'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to Chicago Newsletters')
...
WebUI.scrollToElement(findTestObject('Object Repository/Subscribtion/CHICAGO Group/CHICAGO'), 3)


def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/CHICAGO Group/CHICAGO'),30)
def isChecked = false;
	for (item in list) {
		if ( item.isSelected()) {
			isChecked = true;
