...
WebUI.click(findTestObject('Sign Up v2/New York'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to New York Newsletters')
...
WebUI.scrollToElement(findTestObject('Object Repository/Subscribtion/New York Group/New York Group'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/New York Group/New York Group'),30)
def isChecked = false;
	for (item in list) {
		if ( item.isSelected()) {
			isChecked = true;
