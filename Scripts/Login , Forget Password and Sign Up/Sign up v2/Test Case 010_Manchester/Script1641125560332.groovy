...
WebUI.click(findTestObject('Sign Up v2/Manchester'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to Manchester Newsletters')
...
WebUI.scrollToElement(findTestObject('Object Repository/Subscribtion/MANCHESTER Group/MANCHESTER Group'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/MANCHESTER Group/MANCHESTER Group'),30)
def isChecked = false;
	for (item in list) {
		if ( item.isSelected()) {
			isChecked = true;
