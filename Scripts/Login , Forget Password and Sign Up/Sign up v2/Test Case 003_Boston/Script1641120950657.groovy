...
WebUI.click(findTestObject('Sign Up v2/Boston'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to Boston Newsletters')
...
WebUI.scrollToElement(findTestObject('Object Repository/Subscribtion/BOSTON Group/Boston Group'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/BOSTON Group/Boston Group'),30)
def isChecked = false;
	for (item in list) {
		if ( item.isSelected()) {
			isChecked = true;
