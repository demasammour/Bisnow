...
WebUI.click(findTestObject('Sign Up v2/South Florida'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to South Florida Newsletters')
...
WebUI.scrollToElement(findTestObject('Subscribtion/SOUTHFLORIDA Group/SOUTH FLORIDA Group'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/SOUTHFLORIDA Group/SOUTH FLORIDA Group'), 
    30)
