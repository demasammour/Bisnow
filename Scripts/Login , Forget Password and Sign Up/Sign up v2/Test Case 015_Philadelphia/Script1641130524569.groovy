...
WebUI.click(findTestObject('Sign Up v2/Philadelphia'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to Philadelphia Newsletters')
...
WebUI.scrollToElement(findTestObject('Object Repository/Subscribtion/Philadelphia Group/Philadelphia Group'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/Philadelphia Group/Philadelphia Group'),30)
def isChecked = false;
	for (item in list) {
		if ( item.isSelected()) {
			isChecked = true;
