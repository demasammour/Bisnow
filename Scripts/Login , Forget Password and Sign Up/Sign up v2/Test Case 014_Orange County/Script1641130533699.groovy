...
WebUI.click(findTestObject('Sign Up v2/Orange County'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to Orange County Newsletters')
...
WebUI.scrollToElement(findTestObject('Object Repository/Subscribtion/ORANGE COUNTY Group/ORANGE COUNTY Group'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/ORANGE COUNTY Group/ORANGE COUNTY Group'),30)
def isChecked = false;
	for (item in list) {
		if ( item.isSelected()) {
			isChecked = true;
