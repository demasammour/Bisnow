...
WebUI.click(findTestObject('Sign Up v2/Seattle'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to Seattle Newsletters')
...
WebUI.scrollToElement(findTestObject('Object Repository/Subscribtion/SEATTLE Group/SEATTLE Group'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/SEATTLE Group/SEATTLE Group'),30)
def isChecked = false;
	for (item in list) {
		if ( item.isSelected()) {
			isChecked = true;
