...
WebUI.click(findTestObject('Sign Up v2/Silicon Valley'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to Silicon Valley Newsletter')
...
WebUI.scrollToElement(findTestObject('Subscribtion/SILICON VALLEY Group/SILICON VALLEY Group'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/SILICON VALLEY Group/SILICON VALLEY Group'), 30)
