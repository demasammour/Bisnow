...
WebUI.click(findTestObject('Sign Up v2/Dallas-Ft. Worth'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to Dallas-Fort Worth Newsletters')
...
WebUI.scrollToElement(findTestObject('Object Repository/Subscribtion/DALLAS-FT. WORTH Group/DALLAS-FT. WORTH title'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/DALLAS-FT. WORTH Group/DALLAS-FT. WORTH Group'), 
    30)
