...
WebUI.click(findTestObject('Sign Up v2/London'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to London Newsletters')
...
WebUI.scrollToElement(findTestObject('Subscribtion/London Group/London Group'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/London Group/London Group'), 30)
