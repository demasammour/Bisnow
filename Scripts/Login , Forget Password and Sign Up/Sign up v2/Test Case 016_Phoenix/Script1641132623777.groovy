...
WebUI.click(findTestObject('Sign Up v2/Phoenix'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to Phoenix Newsletters')
...
WebUI.scrollToElement(findTestObject('Object Repository/Subscribtion/PHOENIX Group/PHOENIX Group'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/PHOENIX Group/PHOENIX Group'),30)
def isChecked = false;
	for (item in list) {
		if ( item.isSelected()) {
			isChecked = true;
