...
WebUI.click(findTestObject('Sign Up v2/Los Angeles'))
...
WebUI.getText(findTestObject('Sign Up/Email'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to Los Angeles Newsletters')
...
WebUI.scrollToElement(findTestObject('Object Repository/Subscribtion/LOS ANGELES Group/LOS ANGELES Group'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/LOS ANGELES Group/LOS ANGELES Group'),30)
def isChecked = false;
	for (item in list) {
		if ( item.isSelected()) {
			isChecked = true;
