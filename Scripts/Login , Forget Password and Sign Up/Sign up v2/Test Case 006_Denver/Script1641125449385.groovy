...
WebUI.click(findTestObject('Sign Up v2/Denver'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to Denver Newsletters')
...
WebUI.scrollToElement(findTestObject('Object Repository/Subscribtion/Denver Group/Denver title'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/Denver Group/Denver Group'),30)
def isChecked = false;
	for (item in list) {
		if ( item.isSelected()) {
			isChecked = true;
