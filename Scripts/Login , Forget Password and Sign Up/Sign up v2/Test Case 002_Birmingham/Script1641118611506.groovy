...
WebUI.click(findTestObject('Sign Up v2/Birmingham'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to Birmingham Newsletters')
...
WebUI.scrollToElement(findTestObject('Object Repository/Subscribtion/Birmingham Group/Birmingham title'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/Birmingham Group/Birmingham Group'),30)
def isChecked = false;
	for (item in list) {
		if ( item.isSelected()) {
			isChecked = true;
