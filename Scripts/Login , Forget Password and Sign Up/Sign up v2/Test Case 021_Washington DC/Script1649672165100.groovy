...
WebUI.click(findTestObject('Sign Up v2/Washington DC'))
...
WebUI.verifyElementText(findTestObject('Sign Up v2/Checkbox Subscribe'), 'Subscribe to Washington, D.C. Newsletters')
...
WebUI.scrollToElement(findTestObject('Object Repository/Subscribtion/WASHINGTON DC Group/WASHINGTON DC Group'), 3)

def list = WebUI.findWebElements(findTestObject('Object Repository/Subscribtion/WASHINGTON DC Group/WASHINGTON DC Group'), 
    30)
