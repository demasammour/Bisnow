...
//for (def rowNum=1 ; rowNum <= findTestData("VAT IDS/Valid VAT IDS").getRowNumbers() ;  rowNum ++ ) 
//{
//WebUI.sendKeys(findTestObject('Checkout Page/VAT TAX ID'), findTestData("VAT IDS/Valid VAT IDS").getValue(1,rowNum))
//}  

WebUI.sendKeys(findTestObject('Checkout Page/VAT TAX ID'), VATID)
